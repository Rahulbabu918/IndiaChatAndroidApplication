...
import com.example.indiachats.databinding.ActivitySigninBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnsignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.email.getText().toString(),binding.pasword.getText().toString())
